import { e as useNuxtApp, a as useRuntimeConfig, d as useHead, _ as _export_sfc } from "../server.mjs";
import { defu } from "defu";
import { hasProtocol, withLeadingSlash, joinURL, parseURL, encodePath, encodeParam } from "ufo";
import { appendHeader } from "h3";
import { computed, defineComponent, ref, h, mergeProps, useSSRContext, resolveComponent, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderComponent } from "vue/server-renderer";
...
const Flyout_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {
    ...
    return {
      ...
      r_data: {
        ...
        "nestable-tray": {
          "id": "nestable-tray",
          "name": "Nestable Tray",
          "description": "A basic tray with glued sides and a draft angle. Use 0º if you want a straight sides, but use a larger value if you want trays that can be stacked into eachother. <br/><br/> The length and width are measured at the top, so when you use a non-zero draft angle, the dimensions at the bottom will be smaller. <br/><br/> Because of the draft angle, the trays can be nested. This makes this model ideal as an organizer for storing small items. LEGO®, for example.<br/><br/> If you choose a too large value for the draft angle or a too small value for the height, the draft angle will be adjusted.",
          "tags": [
            "Proffesional",
            "Box",
            "Packaging",
        ...
        "parallelepiped": {
          "id": "parallelepiped",
          "name": "Parallelepiped",
          "description": "A three-dimensional figure formed by six parallelograms. This model can also be used to create a simple brick shape or a dice (cube). In that case, keep the angles at 90º.",
          "tags": [
            "Educational",
            "Shape",
            "Paper Craft",
...
//# sourceMappingURL=index-6a1d5bf4.js.map
