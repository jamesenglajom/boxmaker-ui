import { d as useHead, _ as _export_sfc, e as useNuxtApp, a as useRuntimeConfig } from '../server.mjs';
import { defu } from 'file://C:/xampp/htdocs/projects/boxmaker/node_modules/defu/dist/defu.mjs';
import { encodeParam, hasProtocol, withLeadingSlash, joinURL, parseURL, encodePath } from 'file://C:/xampp/htdocs/projects/boxmaker/node_modules/ufo/dist/index.mjs';
import { appendHeader } from 'file://C:/xampp/htdocs/projects/boxmaker/node_modules/h3/dist/index.mjs';
import { defineComponent, computed, ref, h, useSSRContext, resolveComponent, mergeProps, withCtx, createVNode } from 'file://C:/xampp/htdocs/projects/boxmaker/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from 'file://C:/xampp/htdocs/projects/boxmaker/node_modules/vue/server-renderer/index.mjs';
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file://C:/xampp/htdocs/projects/boxmaker/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxStaticRuntime$NoqSfLI07S = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipxStatic"]: { provider: ipxStaticRuntime$NoqSfLI07S, defaults: {} }
};
const useImage = () => {
  ...
  methods: {
    ...
    adjustELWidth(increase, val) {
      ...
      this.$nextTick(() => {
        ...
        let h2 = this.$refs.selectTray.offsetHeight, DW_DElW = w + tmp;
        ...
        if (DW_DElW > mw - 60) {
          ...
          this.input_el_height = this.FwrapOn ? h2 + 8 : h2 + 38;
          ...
          if (increase) {
            ...
            if (this.selected_items.length == 0) {
              ...
              this.input_el_height = this.selected_items.length == 0 ? 38 : h2 + 8;
              this.option_tray_top = this.input_el_height - 2;
            }
          }
        }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtPicture, {
              ...
              class: "ui image",
              src: `/assets/images/box_icons/${$options.resolveImageName(datum)}`
...
//# sourceMappingURL=index-6a1d5bf4.mjs.map
